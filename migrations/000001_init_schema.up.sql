...
CREATE INDEX IF NOT EXISTS idx_step_executions_status ON workflow_step_executions(workflow_execution_id, status);
CREATE INDEX IF NOT EXISTS idx_rules_tenant_event ON rules(tenant_id, event_type);
